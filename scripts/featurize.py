...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog="featurize",
        description="Compute the feature vectors of a FASTA file."
    )
    ...
    parser.add_argument(
        "--feature-file",
        help="Feature configuration JSON file.",
        default=None
    )
...
def compile_configured_featurizer(feature_file: Optional[str]) -> Tuple[Any, Dict[str, Any]]:
    """
...
def main() -> None:
    ...
    featurize_sequences(featurizer, sequences, args.output_file)  # <-- Pass args.output_file
